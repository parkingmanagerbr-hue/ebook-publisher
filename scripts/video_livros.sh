...
TXT="drawtext=fontfile=$F:text='Livros digitais práticos':fontsize=64:fontcolor=white:x=(w-tw)/2:y=360,drawtext=fontfile=$F:text='Dinheiro, carreira e produtividade':fontsize=40:fontcolor=0xffcf5a:x=(w-tw)/2:y=500,drawtext=fontfile=$F:text='veloxisit.com.br/livros':fontsize=56:fontcolor=0xff6a3d:x=(w-tw)/2:y=640"
